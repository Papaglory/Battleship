...
public class AppInfo {
	 ...
	 */
	public static final Class<?> APP_MAIN_CLASS = inf101.v19.sem2.battleship.Main.class;
	/**
	 * Your name.
	 */
	public static final String APP_DEVELOPER = "Marius H. Naasen";
	/**
	 * A short description.
	 */
	public static final String APP_DESCRIPTION = "Semesteroppgave 2";
	/**
